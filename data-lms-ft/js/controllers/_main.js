/**materialAdmin
    ...
    .controller('materialadminCtrl', function($timeout, $state, $scope, growlService){
        ...
        //Welcome Message
        growlService.growl('Welcome back to FutureTrucks!', 'inverse');
    ...
    // Header
    // =========================================================================
    .controller('headerCtrl', function($timeout, messageService,$scope,$rootScope, $location){
        ...
        function(a){  
            ...
            $scope.hideToggle = $rootScope.currentPath != '/roles/roles';
        });
