materialAdmin
	.controller("tripMemoController", tripMemoController)
	.controller("multiPaymentReceiptCtrl", multiPaymentReceiptCtrl);

tripMemoController.$inject = [
	'$state',
	'$scope',
	'$modal',
	'lazyLoadFactory',
...
function tripMemoController(
	...
	$scope.getAllTripMemo = getAllTripMemo;
	...
	$scope.getTripMemoReport = getTripMemoReport;
	...
	(function init() {
		...
		$scope.tableHead = [
			...
			{
				'header': 'Trip Memo Date',
				'bindingKeys': 'tMemo.date',
				'date': 'dd-MMM-yyyy'
			},
			{
			...
			{
				'header': 'Rate',
				'bindingKeys': 'tMemo.rate'
			},
			{
				'header': 'Munshiyana',
				'bindingKeys': 'tMemo.munshiyana'
			},
			{
				'header': 'Total with Munshiyana',
				'bindingKeys': 'tMemo.total'
			},
			{
				'header': 'Deal Total',
				'bindingKeys': 'tMemo.totalDeal'
			},
			{
	...
	function getAllTripMemo(isGetActive) {
	...
	function getTripMemoReport(type ) {
	...
	function editTripMemo(selectedRow) {
...
function editTripMemoController(
	$scope,
	$uibModalInstance,
	$stateParams,
	DatePicker,
