materialAdmin
	.controller('tripAnalyticsCtrl', tripAnalyticsCtrl);

tripAnalyticsCtrl.$inject = [
	'$timeout',
	'DatePicker',
	'dashboardFactory',
	'dashboardService'
...
function tripAnalyticsCtrl(
	...
	function getAnalytics() {
		...
		dashboardService.getTripAnalytics(request, successCallback, failureCallback);
	...
	function prepareFilter() {
		...
		switch(vm.filter.aggregateByValue){
			...
			case 'Driver Wise' : request.aggregateBy = 'driver'; break;
			case 'Vehicle Wise' : request.aggregateBy = 'vehicle'; break;
		}
	...
	function showFullscreen() {
		dashboardFactory.openFullscreen({
			url: 'views/dashboard/tripAnalytics.html',
			controller: 'tripAnalyticsCtrl'
		}, vm);
	}
