materialAdmin
	.controller('profitAnalyticsCtrl', profitAnalyticsCtrl);

profitAnalyticsCtrl.$inject = [
	'$timeout',
	'DatePicker',
	'dashboardFactory',
	'dashboardService'
...
function profitAnalyticsCtrl(
	...
	vm.options = {
		chart: {
			...
			x: function(d){
				...
				return d._id.billing_party_name;
			},
	...
	function getAnalytics() {
		...
		dashboardService.getProfitAnalytics(request, successCallback, failureCallback);
	...
	function showFullscreen() {
		dashboardFactory.openFullscreen({
			url: 'views/dashboard/profitAnalytics.html',
			controller: 'profitAnalyticsCtrl'
		}, vm);
	}
