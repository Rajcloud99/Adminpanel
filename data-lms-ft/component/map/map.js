...
function mapWrapper($compile){
	return {
		link: function (scope, element, attrs) {
			if(!$(`script[src="https://maps.googleapis.com/maps/api/js?key=${PRIVATE_KEY_GOOGLE}&callback=angular.noop"]`).length){
